...
const firebaseConfig = {
  ...
  databaseURL:
    "https://chuyendoisophuonglaocai-default-rtdb.asia-southeast1.firebasedatabase.app",
...
// Initialize Firebase will be done in separate app scripts to keep this clean
